...
public class TextInputFile {
    ...
    public TextInputFile(File file) {
        try {
            ...
            ErrorReporting.fatalError("Unable to open file \"" + fileName + "\"");
            // Never reaches here
        }
    ...
    public void close() {
        if (closed) {
            ErrorReporting.fatalError("\"" + fileName + "\" is already closed.");
            // Never reaches here.
        }
        ...
        if (useStandardIO) {
            ...
            try {
                ...
                ErrorReporting.fatalError("Close failed: Unable to close \"" + fileName + "\"");
                // Never reaches here.
            }
            f = null;
        }
    ...
    private char readACharacter() {
        try {
            ...
            ErrorReporting.fatalError("Attempt to read past end of file on "
                    + fileName);
            // Never reaches here.
        }
    ...
    private char readACharacterThrowsEOF() throws EOFException {
        ...
        if (closed) {
            ErrorReporting.fatalError("Read failed: \"" + fileName + "\" is already closed.");
            // Never reaches here.
        }
    ...
    private void readALineFromFile() throws EOFException {
        try {
            ...
            if (e instanceof EOFException) {
                ...
                ErrorReporting.fatalError("Read on \"" + fileName + "\" failed: " + e);
            }
        }
    ...
    public String nextLine() {
        ...
        StringBuilder s = new StringBuilder();           // The string typed in
